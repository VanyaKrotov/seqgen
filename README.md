...
Workflow должен уже находиться в основной ветке до отправки тега. При первой
настройке сначала отправьте коммит с `.github/workflows/docker-publish.yml`,
дождитесь его появления в `main` и только затем отдельной командой отправляйте
тег. Если ветка и первый тег были опубликованы одновременно, удалите тег и
создайте новый либо используйте ручной запуск.
