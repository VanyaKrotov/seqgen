...
import { PasswordGeneratorPage } from "~/pages/generator/ui/pages/password-generator-page";
...
export function loader({ context }: Route.LoaderArgs) {
  ...
  return {
    metadata: {
      title: `${i18n.t("generators.password.title")} · Seqgen`,
...
export default function HomeRoute() {
  return (
    <AppShell>
      <PasswordGeneratorPage generator={getGenerator("password")} />
    </AppShell>
  );
}
